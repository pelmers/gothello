...
var diag45map = map[Bitboard]uint{
	A1: 0, A2: 1, A3: 2, A4: 3, A5: 4, A6: 5, A7: 6, A8: 7,
...
var diag135map = map[Bitboard]uint{
...
var rowmasker = func(m Bitboard) Bitboard { return rows[rowmap[m]] }
var colmasker = func(m Bitboard) Bitboard { return cols[colmap[m]] }
var d45masker = func(m Bitboard) Bitboard { return diag45[diag45map[m]] }
var d135masker = func(m Bitboard) Bitboard { return diag135[diag135map[m]] }
var rshifter = func(m Bitboard, c uint) Bitboard { return m >> c }
var lshifter = func(m Bitboard, c uint) Bitboard { return m << c }
var ushifter = func(m Bitboard, c uint) Bitboard { return m << (8 * c) }
var dshifter = func(m Bitboard, c uint) Bitboard { return m >> (8 * c) }
var a45shifter = func(m Bitboard, c uint) Bitboard { return m >> (7 * c) }
var a225shifter = func(m Bitboard, c uint) Bitboard { return m << (7 * c) }
